...
#include "AliAnalysisTaskDirectPhotonsCSL.h"

using namespace std;

ClassImp( AliAnalysisTaskDirectPhotonsCSL );

//--------------------------------------------------------------------------------------------------
AliAnalysisTaskDirectPhotonsCSL::AliAnalysisTaskDirectPhotonsCSL():
    AliAnalysisTaskSE(),
    fOutputList(NULL),
...
//--------------------------------------------------------------------------------------------------
AliAnalysisTaskDirectPhotonsCSL::AliAnalysisTaskDirectPhotonsCSL(const char* name):
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::UserCreateOutputObjects()
{
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::UserExec(Option_t *)
{
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::CalculateEfficiency(){
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::ProcessStackParticles(){
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::ProcessStackInfos(){
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::ProcessDataEfficiency(){
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::ProcessAllTracks(){
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::FindGammaCandidates(){
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::FindNeutralMesonCandidates(){
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::FindTrueNeutralMesonCandidates(){
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::FindSecVertexPosition(TLorentzVector *firstPhotonCandidate){
...
//--------------------------------------------------------------------------------------------------
void AliAnalysisTaskDirectPhotonsCSL::Terminate(Option_t *){
