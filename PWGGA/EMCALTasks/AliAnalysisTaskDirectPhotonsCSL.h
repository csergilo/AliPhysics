#ifndef AliAnalysisTaskDirectPhotonsCSL_h
#define AliAnalysisTaskDirectPhotonsCSL_h
...
class AliAnalysisTaskDirectPhotonsCSL: public AliAnalysisTaskSE
{
public:

    AliAnalysisTaskDirectPhotonsCSL();
    AliAnalysisTaskDirectPhotonsCSL(const char *name);
    virtual             ~AliAnalysisTaskDirectPhotonsCSL();
...
//    TH1D*        fHistTrueDCAToPrimVtx;
 ...
 //   TH1F*        fHistInvMassPosElecAfterDCACut;
    ...
    AliAnalysisTaskDirectPhotonsCSL(const AliAnalysisTaskDirectPhotonsCSL&); // not implemented
    AliAnalysisTaskDirectPhotonsCSL& operator=(const AliAnalysisTaskDirectPhotonsCSL&); // not implemented


ClassDef(AliAnalysisTaskDirectPhotonsCSL, 1);
};
